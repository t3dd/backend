<?php
namespace T3DD\Backend\Tests\Behat;
...
class FlowContext implements Context {
	...
	protected function resetFactories() {
		...
		$fixtureFactoryClassNames = $reflectionService->getAllSubClassNamesForClass('T3DD\Backend\Tests\Functional\Fixture\FixtureFactory');
